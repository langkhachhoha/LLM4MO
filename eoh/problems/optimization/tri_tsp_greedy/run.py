...
class TRITSPCONST():
    ...
    def greedy(self,eva):
        ...
        dis_3 = np.ones(self.n_instance)
        n_ins = 0
        for instance, distance_matrix_1, distance_matrix_2, distance_matrix_3 in self.instance_data:
            ...
            for i in range(1,self.problem_size-1):
                ...
                next_node = eva.select_next_node(current_node, destination_node, unvisited_near_nodes, distance_matrix_1, distance_matrix_2, distance_matrix_3)
            ...
            cost_1, cost_2, cost_3 = self.tour_cost(instance,route,self.problem_size)
        ...
        ave_dis_3 = np.average(dis_3)
        #print("average dis: ",ave_dis)

        return ave_dis_1, ave_dis_2, ave_dis_3
